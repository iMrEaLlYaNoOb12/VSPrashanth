 ...
 * the class.This is an abstract class which has an abstract method and it
 * implements Serializable so that the class can be serialized
 *
 */
public abstract class Disease implements Serializable {
	...
	/**
	 * This is an abstract method which returns a String array.
	 * 
	 * @return String[]
	 */
